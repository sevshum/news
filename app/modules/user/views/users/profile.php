...
if (!isset($tab) || !in_array($tab, ['user', 'profile', 'social', 'settings'], true)) {
                            ...
                            <?php $form = ActiveForm::begin([
                                ...
                                <div class="tabbable tabs-right">
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li class="<?= $tab === 'settings' ? 'active' : '' ?>"><a data-toggle="tab" href="#settings" class="tab-default"><?= Yii::t('app', 'Notifications') ?></a></li>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <?php endif ?>
                                        <div id="settings" class="tab-pane <?= $tab === 'settings' ? 'active' : '' ?>">
                                            <?php foreach ($settings as $index => $setting) {
                                                echo $form->field($setting, "[$index]value")->checkbox(['label' => false])->label(NotificationSetting::types($setting->setting_id));
                                            } ?>
                                        </div>
                                    </div>
                                    <hr>
