...
$( document ).on( "click", "#acceptNotification", function( e ) {
        $.post("/site/accept-notification", function() {
            $(".alert-success.alert .close").trigger("click");
        });
} );
');
?>
